...
public final class BarUtils {
     ...
     * @param isVisible True设置状态栏可见，否则设置为false
     */
    ...
    private static String getResNameById(int id) {
        try {
            return BaseApplication.instance.getResources().getResourceEntryName(id);
    ...
    public static boolean isSupportNavBar() {
        ...
        boolean menu = ViewConfiguration.get(BaseApplication.instance).hasPermanentMenuKey();
